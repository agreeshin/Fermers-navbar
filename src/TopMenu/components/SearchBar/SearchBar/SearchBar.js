        ...
        <div className={styles.buttons}>
          ...
          <button onMouseOver={this.onMagnifierMouseMoveHandler} onMouseLeave={this.onMagnifierMouseLeaveHandler}>
            ...
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.4428 14.4438L18.9991 19.0001M16.7497 8.875C16.7497 13.2242 13.2239 16.75 8.87466 16.75C4.52542 16.75 0.999664 13.2242 0.999664 8.875C0.999664 4.52576 4.52542 1 8.87466 1C13.2239 1 16.7497 4.52576 16.7497 8.875Z" stroke="var(--text-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            :
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M14.4428 14.4438L18.9991 19.0001M16.7497 8.875C16.7497 13.2242 13.2239 16.75 8.87466 16.75C4.52542 16.75 0.999664 13.2242 0.999664 8.875C0.999664 4.52576 4.52542 1 8.87466 1C13.2239 1 16.7497 4.52576 16.7497 8.875Z" stroke="#ACACAC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          }
